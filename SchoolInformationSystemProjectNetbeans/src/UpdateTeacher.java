...
public class UpdateTeacher extends javax.swing.JFrame {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        if(res == JOptionPane.YES_OPTION){
            if(dbh.deleteTeacher(Integer.parseInt(textIdno.getText()))){
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        else if(dbh.searchTeacher(Integer.parseInt(textIdno.getText()), textFname.getText(), textMname.getText(), textLname.getText(), bdate, gender, textEmail.getText(), textContactno.getText(), textStreet.getText(), textBarangay.getText(), textCity.getText(), textProvince.getText()))
            JOptionPane.showMessageDialog(this,"No Changes");
        else if(dbh.updateTeacher(Integer.parseInt(textIdno.getText()), textFname.getText(), textMname.getText(), textLname.getText(), bdate, gender, textStreet.getText(), textBarangay.getText(), textCity.getText(), textProvince.getText(), textEmail.getText(), textContactno.getText())){
            JOptionPane.showMessageDialog(this,"Teacher Updated");
            displayLinkActionPerformed(evt);
        }
        else
            JOptionPane.showMessageDialog(this,"Teacher Not Updated");
